...
public class ConditionsChatMenu {
    public static void openConditionsMenu(Player p, String timerName) {
        ...
        minPlayers.value.setChangeCallback(state -> {
            CommandsManager.changeCommandtimerData(p, timer.getName(), "minPlayers", state.getCurrent().toString());
        });
        menu.add(minPlayers);
        ...
        maxPlayers.value.setChangeCallback(state -> {
            CommandsManager.changeCommandtimerData(p, timer.getName(), "maxPlayers", state.getCurrent().toString());
        });
        menu.add(maxPlayers);
