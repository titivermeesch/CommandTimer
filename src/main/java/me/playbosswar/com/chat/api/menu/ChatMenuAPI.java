...
import me.playbosswar.com.chat.api.protocol.ChatPacketInterceptor;
...
public final class ChatMenuAPI {
     ...
     *
     * @return the menu the player currently has open, or {@code null} if no menu is
     * open.
     */
    @Nullable
    ...
    /**
     * @param player the player whose current menu should be returned
     * @param menu   the menu to set as current, or {@code null} if you want to close
     *                  the current menu.
     */
    ...
    public static int getWidth(@NotNull String text) {
		if (text.contains("\n")) {
			throw new IllegalArgumentException("Cannot get width of text containing " +
													   "newline");
		}
    ...
    /**
     * <b>This method should only be called by you if you're including this API inside
     * your plugin.</b>
     * <br>
     * Initializes all the necessary things for the ChatMenuAPI to function. This method
     * can only be called once.
     *
     * @param plugin the plugin to initialize everything with, including listeners and
     *                  scheduled tasks
     */
     ...
     * your plugin.</b>
     * <br>
     * Disables everything necessary for this API to be reloaded properly without
     * restarting.
     */
