...
public class CMListener implements Listener {
    private static Map<Player, BiFunction<Player, String, Boolean>> chatListeners =
    ...
    public static void expectPlayerChat(Player player, BiFunction<Player, String,
			Boolean> function) {
		if (player == null || !player.isOnline()) {
			throw new IllegalArgumentException("Cannot wait for chat for a " +
													   "null/offline" +
													   " player.");
		}
		if (function == null) {
